  ...
  <section className='container mx-auto  mt-[80px] rounded-xl flex flex-col lg:flex-row items-center'>
    <div className="py-4 px-6 w-full lg:w-1/2 xl:mx-12">
      ...
      <div className='flex justify-center lg:justify-start my-6 lg:my-10 gap-4'>
        <button className='flex items-center gap-2 px-4 py-2 border-solid border-2 border-cyan-300 rounded-md text-blue-custom hover:border-blue-300'>
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
        ...
        <motion.button className='px-4 py-2 bg-blue-custom rounded-md text-white hover:bg-blue-500'>
          Get Started
        </motion.button>
      </div>
    </div>
