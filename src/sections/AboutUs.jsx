    ...
    <section className="about-us py-16 lg:py-[76px] bg-background text-white">
      <div className="container mx-auto flex flex-wrap-reverse justify-center items-center">
        ...
        className='w-full lg:w-[55%] px-6 lg:px-0'>
          ...
          <h1 className='my-5 text-4xl font-bold font-secondary max-w-md'>What makes us different from others</h1>
